...
function GitHubStarsButton({
  ...
  return (
    <motion.a
      ...
      onClick={handleClick}
      className={cn(
        "flex items-center gap-2 text-sm bg-white text-black border border-gray-300 rounded-lg px-4 py-2 h-10 has-[>svg]:px-3 cursor-pointer whitespace-nowrap font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-[18px] shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-gray-500 focus-visible:ring-gray-500/50 focus-visible:ring-[3px] hover:bg-gray-50",
        className,
      )}
      {...props}
    >
